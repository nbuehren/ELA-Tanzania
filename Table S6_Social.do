...
*------------------------------------------------------------------------------*
* ELA Tanzania
* Table S6: Reproductive Health and Empowerment
*------------------------------------------------------------------------------*
*==============================================================================*
...
foreach var of global Reproductive {
	...
	* Output
	qui xtreg `var' followup treatment_clubXfollowup treatment_MFXfollowup, fe cluster(villid)	
	outreg2 using "$output\Table_S6A_Reproductive.tex", append $outopts addstat(T1 vs. T2 p-value,`pval',Control group mean baseline, `mean_control_baseline', Control group mean follow-up,`mean_control_followup')	
}
cap erase "$output\Table_S6A_Reproductive.txt"
...
foreach var of global Empowerment {
	...
	* Output
	qui xtreg `var' followup treatment_clubXfollowup treatment_MFXfollowup, fe cluster(villid)	
	outreg2 using "$output\Table_S6B_Empowerment.tex", append $outopts addstat(T1 vs. T2 p-value,`pval',Control group mean baseline, `mean_control_baseline', Control group mean follow-up,`mean_control_followup')	
}
cap erase "$output\Table_S6B_Empowerment.txt"
